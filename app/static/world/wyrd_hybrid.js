...
const AGENTS = [
  ...
  {id:'arhivarius', e:'🗄',n:'АРХИВАРИУС',     room:'lib',   s:'ghost', d:'Знает весь фонд, управляет читателями. Не создан.'},
  {id:'pisatel',    e:'✍',n:'ПИСАТЕЛЬ',        room:'lib',   s:'ghost', d:'Резюмирует и связывает темы. Не создан.'},
