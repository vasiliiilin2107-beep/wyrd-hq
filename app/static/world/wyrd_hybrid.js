...
const AGENTS = [
  ...
  // БИБЛИОТЕКА
  {id:'bibliotekar',e:'📖',n:'БИБЛИОТЕКАРЬ',   room:'lib',   s:'ghost', d:'Единственная точка входа запросов. Не создан.'},
  {id:'arhivarius', e:'🗄',n:'АРХИВАРИУС',     room:'lib',   s:'live',  d:'✅ Работает в wyrd-library. Знает весь фонд, управляет читателями.'},
  {id:'pisatel',    e:'✍',n:'ПИСАТЕЛЬ',        room:'lib',   s:'live',  d:'✅ Работает в wyrd-library. Резюмирует и связывает темы.'},
